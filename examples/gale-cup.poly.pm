...
◊define-meta[doc-type]{factum}
◊define-meta[court]{SUPREME MOOT COURT OF THE UNIVERSITY OF BRITISH COLUMBIA}
◊define-meta[on-appeal-from]{The Supreme Court of Canada}
◊define-meta[appellant-name]{CATHIE GAUTHIER}
◊define-meta[respondent-name]{HER MAJESTY THE QUEEN}

◊declare-work[#:id "gauthier-scc" #:type "legal-case" #:title "R v Gauthier" #:short-form "*Gauthier* SCC" #:citation "2013 SCC 32"]
◊declare-work[#:id "gauthier-ca" #:type "legal-case" #:title "R v Gauthier" #:short-form "*Gauthier* CA" #:citation "2011 QCCA 1395"]

◊heading{Attribution}

Except for this section, ◊em{this} document is an attempted reproduction of
the factum at
...
◊note-cite["gauthier-scc"] ◊; "cite" in the factum setting needs to not trigger a footnote, but instead, leave placeholders for handling in the decode.
◊note-cite["gauthier-ca"]
